...
public class MainSimulacao {
	...
	public static void executarSimulacao(Runnable meio){
		for (int i = 1; i <= 3; i++){
			...
			Maquina comp1 = new Maquina("127.0.0.1", PORTA_ENTRADA, QTD_PACOTES, 1);
			Maquina comp2 = new Maquina("127.0.0.2", PORTA_SAIDA, QTD_PACOTES, 1);
		...
		System.out.println("Fim de execu��o do Protocolo de teste");
